...
python scripts/review_prompt.py fence PANEL "SECTION CONTRACT=/tmp/section.md" "CANDIDATE DIFF=/tmp/review-diff.patch" > /tmp/fenced.md
...
python scripts/review_prompt.py check-panel < <panel output file>
```
...
python scripts/review_prompt.py check-plan < <plan output file>
```

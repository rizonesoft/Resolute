...
Func _Localization_Custom()
	...
	$g_aLangCustom[26] = _Localization_Load("Custom", "Label_Notice", "%{Program.Name} is designed to run in a server environment. We created Firemin for desktop environments. Read more...")

...
Func _Localization_Custom()
	...
	$g_aLangCustom[0]  = _Localization_Load("Custom", "Label_Status_Welcome", "Start with loading the browser (select the filename).\r\nFiremin will automatically detect the process from the executable you select.")
	...
	$g_aLangCustom[25] = _Localization_Load("Custom", "Tip_Minimized_Message", "%{Program.Name} will continue to run to optimize %s's memory usage.\r\nClick the tray icon to change various optimization options.")
	$g_aLangCustom[26] = _Localization_Load("Custom", "Label_Notice", "%{Program.Name} is designed to run on a desktop computer or laptop.\r\nWe created Firemin Server for server environments. Read more...")
...
Func _Localization_Preferences()
	...
	$g_aLangPreferences[10] = _Localization_Load("Preferences", "Label_Extended_Processes", "Enter here the names of any additional processes you would like %{Program.Name} to optimize.\r\nThe list must be comma separated (Process01.exe, Process02.exe, etc)")
	...
	$g_aLangPreferences[14] = _Localization_Load("Preferences", "Label_Language_Message", "Select the language you prefer and press the %s button to continue.\r\n(Restart Required)")
	...
	$g_aLangPreferences[19] = _Localization_Load("Preferences", "MsgBox_Language_Message", "The selected language has changed.\r\nComplete Internet Repair should be restarted for the chosen language to take effect.")
	...
	$g_aLangPreferences[22] = _Localization_Load("Preferences", "Button_Export", "Export")
	$g_aLangPreferences[23] = _Localization_Load("Preferences", "Dialog_Export_Title", "Export Extended Processes")
	$g_aLangPreferences[24] = _Localization_Load("Preferences", "Dialog_Export_Error_Title", "Export Error")
	$g_aLangPreferences[25] = _Localization_Load("Preferences", "Dialog_Export_Error_Message", "Failed to create the export file.")
	$g_aLangPreferences[26] = _Localization_Load("Preferences", "Dialog_Export_Success_Title", "Export Successful")
	$g_aLangPreferences[27] = _Localization_Load("Preferences", "Dialog_Export_Success_Message", "Extended Processes list exported to:")
	$g_aLangPreferences[28] = _Localization_Load("Preferences", "Button_Import", "Import")
	$g_aLangPreferences[29] = _Localization_Load("Preferences", "Dialog_Import_Title", "Import Extended Processes")
	$g_aLangPreferences[30] = _Localization_Load("Preferences", "Dialog_Import_Error_Title", "Import Error")
	$g_aLangPreferences[31] = _Localization_Load("Preferences", "Dialog_Import_Error_Message", "Failed to read the import file.")
	$g_aLangPreferences[32] = _Localization_Load("Preferences", "Dialog_Import_Success_Title", "Import Successful")
	$g_aLangPreferences[33] = _Localization_Load("Preferences", "Dialog_Import_Success_Message", "Extended Processes list has been imported successfully.")
	$g_aLangPreferences[34] = _Localization_Load("Preferences", "Dialog_Import_Empty_Title", "No Processes Found")
	$g_aLangPreferences[35] = _Localization_Load("Preferences", "Dialog_Import_Empty_Message", "No valid processes were found in the selected file.")

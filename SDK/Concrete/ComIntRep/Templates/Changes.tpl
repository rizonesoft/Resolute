...
--------------------------------------------------
Version 9.0.0.5601 (SEPTEMBER 04, 2022)
--------------------------------------------------
...
--------------------------------------------------
Version 8.1.3.5260 (MAY 25, 2021)
--------------------------------------------------
...
--------------------------------------------------
Version 8.1.3.5228 (APRIL 07, 2021)
--------------------------------------------------
...
--------------------------------------------------
Version 5.2.3.4005 (October 25, 2018)
--------------------------------------------------

- Updated Hungarian translation.

--------------------------------------------------
Version 5.2.3.4002 (October 19, 2018)
--------------------------------------------------

- Updated Slovenian translation.

--------------------------------------------------
Version 5.2.3.4000 (October 16, 2018)
--------------------------------------------------
...
--------------------------------------------------
Version 5.1.0.3890 (February 13, 2018)
--------------------------------------------------

- Fix: Not able to select language with installed version.
- Removed Winsock Fix and Boot Message from Renew TCP/IP.
...
--------------------------------------------------
Version 5.0.1.3860 (February 02, 2018)
--------------------------------------------------

- Added support for Hungarian language.
- Added Hungarian language file.
- French language file updates as suggested by @hpwamr

--------------------------------------------------
Version 5.0.1.3852 (January 21, 2018)
--------------------------------------------------
...
- Change: Boot_10 -> Boot_Restarting
- Change: Boot_11 -> Boot_Canceled
- New: [Preferences] MsgBox_Closing_Title = Closing %{Program.Name}
- New: [Preferences] MsgBox_Closing_Message = Would you like to close %{Program.Name} now?

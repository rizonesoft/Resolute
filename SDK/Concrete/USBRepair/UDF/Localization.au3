...
Func _Localization_Custom()
	...
	$g_aLangCustom[3] = _Localization_Load("Custom", "Button_Repair", "Repair USB")
...
Func _Localization_Menus()
	...
	$g_aLangMenus[12] = _Localization_Load("Menus", "Help", "&Help")
	$g_aLangMenus[13] = _Localization_Load("Menus", "Help_Update", "Check for &updates")
	$g_aLangMenus[14] = _Localization_Load("Menus", "Help_Home", "%{Company.Name} &Home")
	$g_aLangMenus[15] = _Localization_Load("Menus", "Help_Downloads", "More &Downloads")
	$g_aLangMenus[16] = _Localization_Load("Menus", "Help_Support", "&Get Support")
	$g_aLangMenus[17] = _Localization_Load("Menus", "Help_Issue", "Create an &issue")
	$g_aLangMenus[18] = _Localization_Load("Menus", "Help_Donate", "Donate to &our Cause")
	$g_aLangMenus[19] = _Localization_Load("Menus", "Help_About", "About %{Program.Name}")
...
Func _Localization_Messages2()
	...
	$g_aLangMessages2[12] = _Localization_Load("Messages2", "Repair_USB_02", "Resetting Upper and Lower Filters.")
	$g_aLangMessages2[13] = _Localization_Load("Messages2", "Repair_USB_03", "Hope that resolved your USB issues. If not, it could be a physical hardware problem.")

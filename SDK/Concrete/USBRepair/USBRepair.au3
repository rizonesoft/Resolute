...
; Aut2Exe Settings
;===============================================================================================================
#AutoIt3Wrapper_Icon=..\..\Resources\Icons\USBRepair.ico			;~ Filename of the Ico file to use for the compiled exe
#AutoIt3Wrapper_OutFile_Type=exe									;~ exe=Standalone executable (Default); a3x=Tokenised AutoIt3 code file
#AutoIt3Wrapper_OutFile=..\..\..\Resolute\USBRepair.exe				;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\..\..\Resolute\USBRepair_X64.exe		;~ Target exe filename for X64 compile.
...
#AutoIt3Wrapper_Res_Field=ProductName|USB Repair
...
; Remove resources
#AutoIt3Wrapper_Res_Icon_Add=..\..\Resources\Icons\USBRepairH.ico				; 201
...
Global $g_sProgShortName		= "USBRepair"
Global $g_sProgShortName_X64	= $g_sProgShortName & "_X64"
Global $g_sProgName				= "USB Repair"
...
Global $g_sUrlProgPage			= "https://rizonesoft.com/downloads/usb-repair/|www.rizonesoft.com/downloads/usb-repair/"
...
Func _StartCoreGui()
	...
	$g_hMenuHelp = GUICtrlCreateMenu($g_aLangMenus[12])
	...
	$g_hUpdateMenuItem = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[13], $g_hMenuHelp, $g_aMenuIcons[7], $g_iMenuIconsStart + 7)
	_GuiCtrlMenuEx_CreateMenuItem("", $g_hMenuHelp)
	$miHelpHome = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[14], $g_hMenuHelp, $g_aMenuIcons[8], $g_iMenuIconsStart + 8)
	$miHelpDownloads = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[15], $g_hMenuHelp)
	$miHelpSupport = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[16], $g_hMenuHelp, $g_aMenuIcons[9], $g_iMenuIconsStart + 9)
	_GuiCtrlMenuEx_CreateMenuItem("", $g_hMenuHelp)
	$miHelpGitHub = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[17], $g_hMenuHelp, $g_aMenuIcons[10], $g_iMenuIconsStart + 10)
	$miHelpDonate = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[18], $g_hMenuHelp)
	_GuiCtrlMenuEx_CreateMenuItem("", $g_hMenuHelp)
	$miHelpAbout = _GuiCtrlMenuEx_CreateMenuItem($g_aLangMenus[19], $g_hMenuHelp, $g_aMenuIcons[11], $g_iMenuIconsStart + 11)

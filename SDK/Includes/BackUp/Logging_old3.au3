...
Func _Logging_EditWrite($sMessage = "", $bTimePrex = True, $bToLogFile = True)
    ...
    If $g_ShowInterface Then
        For $i = 1 To $aLines[0] ; Loop through each line
            ...
            _GUICtrlListView_AddItem($g_hListStatus, Chr(32) & $sLine, $iImage) ; Add each line as a separate item
...
Func __Logging_ValidateSuccess($sMessage)
	...
	Local $sSuccessStrings = "success|Response Received|Successfully|OK!|: OK|Registration succeeded|Initiated|Clean|Database test passed.|" & _

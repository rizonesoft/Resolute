...
; Aut2Exe Settings
;===============================================================================================================
#AutoIt3Wrapper_Icon=..\..\Resources\Icons\Watermin.ico			;~ Filename of the Ico file to use for the compiled exe
#AutoIt3Wrapper_OutFile_Type=exe								;~ exe=Standalone executable (Default); a3x=Tokenised AutoIt3 code file
#AutoIt3Wrapper_OutFile=..\..\..\Resolute\Watermin.exe			;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\..\..\Resolute\Watermin_X64.exe	;~ Target exe filename for X64 compile.
...
#AutoIt3Wrapper_Res_Field=ProductName|Watermin
...
; Remove resources
#AutoIt3Wrapper_Res_Icon_Add=..\..\Resources\Icons\WaterminH.ico						; 201
...
Global $g_sProgShortName		= "Watermin"
Global $g_sProgShortName_X64	= $g_sProgShortName & "_X64"
Global $g_sProgName				= "Watermin"
...
Func _StartCoreGui()
	...
	GUICtrlSetState($g_hChkStartWindows, FileExists(@StartupDir & "\Watermin.lnk"))
...
Func _LoadConfiguration()
	...
	$g_sBrowserPath = IniRead($g_sPathIni, $g_sProgShortName, "BrowserPath", @ProgramFilesDir & "\Waterfox\waterfox.exe")
...
Func _SaveWaterminConfig()
	...
	If GUICtrlRead($g_hChkStartWindows) = $GUI_CHECKED Then
		FileDelete(@StartupDir & "\Watermin.lnk")
		FileCreateShortcut(@ScriptFullPath, @StartupDir & "\Watermin.lnk", @StartupDir)
	Else
		FileDelete(@StartupDir & "\Watermin.lnk")
	EndIf

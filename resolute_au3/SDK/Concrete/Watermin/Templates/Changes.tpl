...
--------------------------------------------------
Version 11.8.3.8535 (DECEMBER 5, 2024)
--------------------------------------------------

Initial Release:
- Watermine memory optimization and management
- System-wide memory monitoring with configurable thresholds
- Process-specific memory limits
- Real-time memory usage display
- Support for Watermine and Watermine-based Waterfox browsers
- Portable and installer versions available
- Multi-language support (19 languages)
- Automatic Watermine process detection
- Extended process management for Watermine extensions
- System tray integration
- Auto-start with Windows option
- Memory reduction with customizable intervals

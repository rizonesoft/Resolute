...
#define distrodir "PixRepair_1008"


#define app_version   "11.1.1.1008"
#define app_name      "Pixel Repair"
...
UninstallDisplayIcon={app}\PixRepair.exe
UninstallDisplayName={#app_name} {#app_version}
DefaultDirName={pf}\Rizonesoft\Pixel Repair
LicenseFile=PixRepair_1008\Docs\PixRepair\License.txt
OutputDir=.
OutputBaseFilename=PixRepair_1008_Setup
...
SetupMutex="pixrepair_setup_mutex"
...
[Files]
Source: {#distrodir}\PixRepair_X64.exe; DestDir: {app}; DestName: PixRepair.exe; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: {#distrodir}\PixRepair.exe; DestDir: {app}; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: {#distrodir}\PixRepair.ini; DestDir: {userappdata}\Rizonesoft\PixRepair; Flags: onlyifdoesntexist uninsneveruninstall
Source: {#distrodir}\PixRepair.exe; DestDir: {app}; Flags: ignoreversion
Source: {#distrodir}\PixRepair_X64.exe; DestDir: {app}; Flags: ignoreversion
Source: {#distrodir}\Docs\PixRepair\Changes.txt; DestDir: {app}\Docs\PixRepair; Flags: ignoreversion
Source: {#distrodir}\Docs\PixRepair\License.txt; DestDir: {app}\Docs\PixRepair; Flags: ignoreversion
Source: {#distrodir}\Docs\PixRepair\Readme.txt; DestDir: {app}\Docs\PixRepair; Flags: ignoreversion
Source: {#distrodir}\Language\PixRepair\en.ini; DestDir: {app}\Language\PixRepair; Flags: ignoreversion
...
[Icons]
Name: {commondesktop}\{#app_name}; Filename: {app}\PixRepair.exe; Tasks: desktopicon\common; Comment: {#app_name} {#app_version}; WorkingDir: {app}; AppUserModelID: PixRepair; IconFilename: {app}\PixRepair.exe; IconIndex: 0
Name: {userdesktop}\{#app_name};   Filename: {app}\PixRepair.exe; Tasks: desktopicon\user;   Comment: {#app_name} {#app_version}; WorkingDir: {app}; AppUserModelID: PixRepair; IconFilename: {app}\PixRepair.exe; IconIndex: 0
Name: {userstartmenu}\{#app_name}; Filename: {app}\PixRepair.exe; Tasks: startup_icon;       Comment: {#app_name} {#app_version}; WorkingDir: {app}; AppUserModelID: PixRepair; IconFilename: {app}\PixRepair.exe; IconIndex: 0
Name: {#quick_launch}\{#app_name}; Filename: {app}\PixRepair.exe; Tasks: quicklaunchicon;    Comment: {#app_name} {#app_version}; WorkingDir: {app};                        					IconFilename: {app}\PixRepair.exe; IconIndex: 0

[INI]
Filename: {app}\PixRepair.ini; Section: PixRepair; Key: PortableEdition; String: 0
Filename: {userappdata}\Rizonesoft\PixRepair\PixRepair.ini; Section: PixRepair; Key: PortableEdition; String: 0

[Run]
Filename: {app}\PixRepair.exe; Description: {cm:LaunchProgram,{#app_name}}; WorkingDir: {app}; Flags: nowait postinstall shellexec skipifsilent unchecked
...
Type: files;      Name: {app}\PixRepair.ini
...
// Check if Pixel Repair's settings exist.
function SettingsExistCheck(): Boolean;
begin
	if FileExists(ExpandConstant('{userappdata}\Rizonesoft\PixRepair\PixRepair.ini')) then begin
...
begin
	DeleteFile(ExpandConstant('{userappdata}\Rizonesoft\PixRepair\PixRepair.ini'));
	RemoveDir(ExpandConstant('{userappdata}\Rizonesoft\PixRepair'));
end;
...
var
	ErrorCode: Integer;
begin
	// When uninstalling, ask the user to delete Pixel Repair's settings.
...
begin
	...
	PromoPage := CreateCustomPage(wpWelcome, 'Pixel Repair', 'Thank you for choosing Pixel Repair.');

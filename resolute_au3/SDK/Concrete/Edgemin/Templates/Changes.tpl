...
Initial Release:
- Edge memory optimization and management
- System-wide memory monitoring with configurable thresholds
- Process-specific memory limits
- Real-time memory usage display
- Support for Edge and Edge-based browsers
- Portable and installer versions available
- Multi-language support (19 languages)
- Automatic Edge process detection
- Extended process management for Edge extensions

...
; Aut2Exe Settings
;===============================================================================================================
#AutoIt3Wrapper_Icon=..\..\Resources\Icons\Edgemin.ico			;~ Filename of the Ico file to use for the compiled exe
#AutoIt3Wrapper_OutFile_Type=exe								;~ exe=Standalone executable (Default); a3x=Tokenised AutoIt3 code file
#AutoIt3Wrapper_OutFile=..\..\..\Resolute\Edgemin.exe			;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\..\..\Resolute\Edgemin_X64.exe	;~ Target exe filename for X64 compile.
...
;===============================================================================================================
#AutoIt3Wrapper_Res_Comment=Edgemin									;~ Comment field
#AutoIt3Wrapper_Res_Description=Edgemin						      	;~ Description field
...
#AutoIt3Wrapper_Res_Field=ProductName|Edgemin
...
; Remove resources
#AutoIt3Wrapper_Res_Icon_Add=..\..\Resources\Icons\EdgeminH.ico						; 201
...
Global $g_sProgShortName		= "Edgemin"
Global $g_sProgShortName_X64	= $g_sProgShortName & "_X64"
Global $g_sProgName				= "Edgemin"
...
Global $g_sUrlProgPage			= "https://rizonesoft.com/downloads/chromin/|rizonesoft.com/downloads/chromin/"
Global $g_sUrlUpdate			= "https://rizonesoft.com/downloads/chromin/"
...
Global $g_sBrowserPath		 = @ProgramFilesDir & "\Microsoft\Edge\Application\msedge.exe"
...
Func _StartCoreGui()
	...
	GUICtrlSetOnEvent($g_hBtnSave, "_SaveEdgeminConfig")
	...
	GUICtrlSetState($g_hChkStartWindows, FileExists(@StartupDir & "\Edgemin.lnk"))
...
Func _LoadConfiguration()
	...
	$g_sBrowserPath = IniRead($g_sPathIni, $g_sProgShortName, "BrowserPath", @ProgramFilesDir & "\Microsoft\Edge\Application\msedge.exe")
...
Func _SaveEdgeminConfig()
	...
	If GUICtrlRead($g_hChkStartWindows) = $GUI_CHECKED Then
		FileDelete(@StartupDir & "\Edgemin.lnk")
		FileCreateShortcut(@ScriptFullPath, @StartupDir & "\Edgemin.lnk", @StartupDir)
	Else
		FileDelete(@StartupDir & "\Edgemin.lnk")
	EndIf
...
Func _LoadBrowser($sBrowserPath)
	...
	Else
		...
		$sBrowserPath = @ProgramFilesDir & "\Microsoft\Edge\Application\msedge.exe"
...
Func _ClearExtendedProcs()
    ...
    If TimerDiff($hLastUsageUpdate) >= 1000 Then
        ...
        For $x = 0 To UBound($aProcs) - 1
            ...
            Local $sCleanProc = StringStripWS($aProcs[$x], 3)
            ...
            If $sCleanProc <> "" Then
                ...
                If Not @error And $aProcessList[0][0] > 0 Then
                    ; Add up memory usage for all instances of this process

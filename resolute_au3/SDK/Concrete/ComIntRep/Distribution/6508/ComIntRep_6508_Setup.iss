...
#define distrodir "ComIntRep_6508"


#define app_version   "11.1.3.6508"
...
LicenseFile=ComIntRep_6508\Docs\ComIntRep\License.txt
OutputDir=.
OutputBaseFilename=ComIntRep_6508_Setup
...
Source: {#distrodir}\ComIntRep.exe; DestDir: {app}; Flags: ignoreversion
Source: {#distrodir}\ComIntRep_X64.exe; DestDir: {app}; Flags: ignoreversion
...
Source: {#distrodir}\Language\ComIntRep\ar.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\de.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\el.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\en.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\es.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\fr.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\hu.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\it.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\ko.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\pt-BR.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\ru.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\sl.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\tr.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\zh-CN.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
Source: {#distrodir}\Language\ComIntRep\zh-TW.ini; DestDir: {app}\Language\ComIntRep; Flags: ignoreversion
...
begin
	...
	PromoPage := CreateCustomPage(wpWelcome, 'Complete Internet Repair', 'Thank you for choosing Complete Internet Repair.');

;* Beep Codes Viewer - Installer script
...
#define distrodir "BiosCodes_1959"


#define app_version   "11.1.1.1959"
#define app_name      "Beep Codes Viewer"
...
UninstallDisplayIcon={app}\BiosCodes.exe
UninstallDisplayName={#app_name} {#app_version}
DefaultDirName={pf}\Rizonesoft\Beep Codes Viewer
LicenseFile=BiosCodes_1959\Docs\BiosCodes\License.txt
OutputDir=.
OutputBaseFilename=BiosCodes_1959_Setup
...
[Files]
Source: {#distrodir}\BiosCodes_X64.exe; DestDir: {app}; DestName: BiosCodes.exe; Flags: ignoreversion; Check: Is64BitInstallMode()
Source: {#distrodir}\BiosCodes.exe; DestDir: {app}; Flags: ignoreversion; Check: not Is64BitInstallMode()
Source: {#distrodir}\BiosCodes.ini; DestDir: {userappdata}\Rizonesoft\BiosCodes; Flags: onlyifdoesntexist uninsneveruninstall
Source: {#distrodir}\BiosCodes.exe; DestDir: {app}; Flags: ignoreversion
Source: {#distrodir}\BiosCodes_X64.exe; DestDir: {app}; Flags: ignoreversion
Source: {#distrodir}\Docs\BiosCodes\Changes.txt; DestDir: {app}\Docs\BiosCodes; Flags: ignoreversion
Source: {#distrodir}\Docs\BiosCodes\License.txt; DestDir: {app}\Docs\BiosCodes; Flags: ignoreversion
Source: {#distrodir}\Docs\BiosCodes\Readme.txt; DestDir: {app}\Docs\BiosCodes; Flags: ignoreversion
Source: {#distrodir}\Language\BiosCodes\en.ini; DestDir: {app}\Language\BiosCodes; Flags: ignoreversion
...
[Icons]
Name: {commondesktop}\{#app_name}; Filename: {app}\BiosCodes.exe; Tasks: desktopicon\common; Comment: {#app_name} {#app_version}; WorkingDir: {app}; AppUserModelID: BiosCodes; IconFilename: {app}\BiosCodes.exe; IconIndex: 0
Name: {userdesktop}\{#app_name};   Filename: {app}\BiosCodes.exe; Tasks: desktopicon\user;   Comment: {#app_name} {#app_version}; WorkingDir: {app}; AppUserModelID: BiosCodes; IconFilename: {app}\BiosCodes.exe; IconIndex: 0
Name: {userstartmenu}\{#app_name}; Filename: {app}\BiosCodes.exe; Tasks: startup_icon;       Comment: {#app_name} {#app_version}; WorkingDir: {app}; AppUserModelID: BiosCodes; IconFilename: {app}\BiosCodes.exe; IconIndex: 0
Name: {#quick_launch}\{#app_name}; Filename: {app}\BiosCodes.exe; Tasks: quicklaunchicon;    Comment: {#app_name} {#app_version}; WorkingDir: {app};                        					IconFilename: {app}\BiosCodes.exe; IconIndex: 0

[INI]
Filename: {app}\BiosCodes.ini; Section: BiosCodes; Key: PortableEdition; String: 0
Filename: {userappdata}\Rizonesoft\BiosCodes\BiosCodes.ini; Section: BiosCodes; Key: PortableEdition; String: 0

[Run]
Filename: {app}\BiosCodes.exe; Description: {cm:LaunchProgram,{#app_name}}; WorkingDir: {app}; Flags: nowait postinstall shellexec skipifsilent unchecked
...
Type: files;      Name: {app}\BiosCodes.ini
...
begin
	if FileExists(ExpandConstant('{userappdata}\Rizonesoft\BiosCodes\BiosCodes.ini')) then begin
...
begin
	DeleteFile(ExpandConstant('{userappdata}\Rizonesoft\BiosCodes\BiosCodes.ini'));
	RemoveDir(ExpandConstant('{userappdata}\Rizonesoft\BiosCodes'));
end;
...
begin
	...
	PromoPage := CreateCustomPage(wpWelcome, 'Beep Codes Viewer', 'Thank you for choosing Beep Codes Viewer.');

...
;*   Beep Codes Viewer       -> Environment["Name"]          (e.g., "Beep Codes Viewer")
;*   BiosCodes  -> Environment["ShortName"]     (e.g., "BiosCodes")
;*   BiosCodes_1994    -> Environment["DistributionName"] (e.g., "BiosCodes_1992")
;*
;* The generated script will be written to Distribution\<Build>\ and will reference
;* the distribution folder BiosCodes_1994 as a sibling directory.
...
Source: {#distrodir}\\BiosCodes.ini; DestDir: {app}; Flags: ignoreversion
...
Source: {#distrodir}\Language\BiosCodes\de.lng; DestDir: {app}\Language\BiosCodes; Flags: ignoreversion
Source: {#distrodir}\Language\BiosCodes\en.lng; DestDir: {app}\Language\BiosCodes; Flags: ignoreversion
Source: {#distrodir}\Language\BiosCodes\ko.lng; DestDir: {app}\Language\BiosCodes; Flags: ignoreversion

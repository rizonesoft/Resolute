...
; Aut2Exe Settings
;===============================================================================================================
#AutoIt3Wrapper_Icon=..\..\Resources\Icons\Chromin.ico			;~ Filename of the Ico file to use for the compiled exe
#AutoIt3Wrapper_OutFile_Type=exe								;~ exe=Standalone executable (Default); a3x=Tokenised AutoIt3 code file
#AutoIt3Wrapper_OutFile=..\..\..\Resolute\Chromin.exe			;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\..\..\Resolute\Chromin_X64.exe	;~ Target exe filename for X64 compile.
...
;===============================================================================================================
#AutoIt3Wrapper_Res_Comment=Chromin									;~ Comment field
#AutoIt3Wrapper_Res_Description=Chromin						      	;~ Description field
...
#AutoIt3Wrapper_Res_Field=ProductName|Chromin
...
; Remove resources
#AutoIt3Wrapper_Res_Icon_Add=..\..\Resources\Icons\ChrominH.ico						; 201
...
Global $g_sProgShortName		= "Chromin"
Global $g_sProgShortName_X64	= $g_sProgShortName & "_X64"
Global $g_sProgName				= "Chromin"
...
Global $g_sBrowserPath		 = @ProgramFilesDir & "\Google\Chrome\Application\chrome.exe"
...
Func _StartCoreGui()
	...
	GUICtrlSetOnEvent($g_hBtnSave, "_SaveChrominConfig")
	...
	GUICtrlSetState($g_hChkStartWindows, FileExists(@StartupDir & "\Chromin.lnk"))
...
Func _LoadConfiguration()
	...
	$g_sBrowserPath = IniRead($g_sPathIni, $g_sProgShortName, "BrowserPath", @ProgramFilesDir & "\Google\Chrome\Application\chrome.exe")
...
Func _SaveChrominConfig()
	...
	If GUICtrlRead($g_hChkStartWindows) = $GUI_CHECKED Then
		FileDelete(@StartupDir & "\Chromin.lnk")
		FileCreateShortcut(@ScriptFullPath, @StartupDir & "\Chromin.lnk", @StartupDir)
	Else
		FileDelete(@StartupDir & "\Chromin.lnk")
	EndIf
...
Func _LoadBrowser($sBrowserPath)
	...
	Else
		...
		$sBrowserPath = @ProgramFilesDir & "\Google\Chrome\Application\chrome.exe"

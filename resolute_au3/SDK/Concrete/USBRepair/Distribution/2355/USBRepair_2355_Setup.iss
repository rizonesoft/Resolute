...
#define distrodir "USBRepair_2355"


#define app_version   "9.2.3.2355"
...
AppUpdatesURL=https://www.rizonesoft.com/downloads/usb-repair/
...
LicenseFile=USBRepair_2355\Docs\USBRepair\License.txt
OutputDir=.
OutputBaseFilename=USBRepair_2355_Setup
...
begin
	...
	PromoPage := CreateCustomPage(wpWelcome, 'USB Repair', 'Thank you for choosing USB Repair.');

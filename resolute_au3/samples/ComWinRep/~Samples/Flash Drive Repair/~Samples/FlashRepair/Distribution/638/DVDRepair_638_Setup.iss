...
#define distrodir "DVDRepair_638"

#ifnexist distrodir + "\DVDRepair.exe"
	#error Compile DVDRepair.exe first.
#endif

#ifnexist distrodir + "\DVDRepair_X64.exe"
	#error Compile DVDRepair_X64.exe first.
#endif
...
AppPublisherURL=http://www.rizonesoft.com
AppSupportURL=http://www.rizonesoft.com
AppUpdatesURL=http://www.rizonesoft.com/downloads/dvd-drive-repair/
AppContact=http://www.rizonesoft.com
AppCopyright={#app_copyright}
UninstallDisplayIcon={app}\DVDRepair.exe
UninstallDisplayName={#app_name} {#app_version}
DefaultDirName={pf}\Rizonesoft\DVD Drive Repair
LicenseFile=DVDRepair_638\License.txt
OutputDir=.
OutputBaseFilename=DVDRepair_638_Setup
...
SetupMutex="DVD Drive Repair_setup_mutex"
...
[Dirs]
Name: {userappdata}\Rizonesoft\DVDRepair\Logging
...
Filename: "http://www.rizonesoft.com"; Flags: shellexec

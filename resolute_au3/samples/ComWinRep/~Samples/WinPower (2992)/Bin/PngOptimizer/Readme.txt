-----------------------------------------------------------------------------
  PngOptimizer - Copyright (C) 2002/2008 Hadrien Nilsson - psydk.org
-----------------------------------------------------------------------------
...
Contributions : 
- PngOptimizer icon by Guillaume Schaeffer (giz404@yahoo.fr)
...
For advanced settings, perform a right click to display a context menu :
...
* Keep background color *
 ...
 Adding an explicit background color in a PNG file (with an utility like
 TweakPNG) is a good tip to have 32 bits transparent PNGs compatible with 
 Internet Explorer 6 and modern browsers at the same time.

 With this option, PngOptimizer keeps the background color chunk you added.
...
* Clear list
 ...
 Clears er... the list :) Alternatively, you can use the shortcut key 
 Ctrl+Shift+Delete (the same shortcut as Winamp playlist).

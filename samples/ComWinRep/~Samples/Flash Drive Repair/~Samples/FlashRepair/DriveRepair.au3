...
#Autoit3Wrapper_If_Compile
	...
	; Aut2Exe Settings
	;===============================================================================================================
	#AutoIt3Wrapper_Icon=Themes\Icons\FlashRepair.ico					 ;~ Filename of the Ico file to use for the compiled exe
	#AutoIt3Wrapper_OutFile_Type=exe								 ;~ exe=Standalone executable (Default); a3x=Tokenised AutoIt3 code file
	#AutoIt3Wrapper_OutFile=FlashRepair.exe							 ;~ Target exe/a3x filename.
	#AutoIt3Wrapper_OutFile_X64=FlashRepair_X64.exe					 ;~ Target exe filename for X64 compile.
	...
	;===============================================================================================================
	#AutoIt3Wrapper_Res_Comment=Flash Drive Repair								 	 ;~ Comment field
	#AutoIt3Wrapper_Res_Description=Rizonesoft Flash Drive Repair				      	 ;~ Description field
	#AutoIt3Wrapper_Res_Fileversion=1.0.2.837
	...
	#AutoIt3Wrapper_Res_Field=ProductName|Flash Drive Repair
	...
	; Remove resources
	#AutoIt3Wrapper_Res_Icon_Add=Themes\Icons\FlashRepairH.ico
	;===============================================================================================================
	; Tidy Settings
	;===============================================================================================================
...
If Not @AutoItX64 And @OSArch = "X64" Then
	...
	If FileExists(@ScriptDir & "\FlashRepair_x64.exe") Then
		ShellExecute(@ScriptDir & "\FlashRepair_x64.exe")
		Exit
	Else
...
Func _StartCoreGUI()
	...
	GUICtrlCreateLabel("If your USB Drives is missing from " & _GetWindowsVersion() & " or it is not recognized by" & _
			" some applications, click 'Repair USB Drives' and restart your computer." & _

...
Func _ConvertBytesTable($BYTES = 0)
	If $BYTES >= 0 And $BYTES < 1024 Then Return $BYTES & " B"
	If $BYTES > 1024 And $BYTES < 1048576 Then Return Round($BYTES / 1024, 2) & " KB"
	If $BYTES > 1048576 And $BYTES < 1073741824 Then Return Round($BYTES / 1048576, 2) & " MB"
	If $BYTES > 1073741824 And $BYTES < 1099511627776 Then Return Round($BYTES / 1073741824, 2) & " GB"
	If $BYTES > 1099511627776 And $BYTES < 1125899906842624 Then Return Round($BYTES / 1099511627776, 2) & " TB"
EndFunc

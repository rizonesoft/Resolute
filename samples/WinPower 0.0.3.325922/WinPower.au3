...
EndIf
	...
	$AdHardMenu = GUICtrlCreateMenu("&Hardware Management", $AdminMenu)
	$HmBiometric = GUICtrlCreateMenuItem("&Biometric Devices", $AdHardMenu)

	GUICtrlSetOnEvent($HmBiometric, "_StartBiometricDevices")

	$ControlMenu = GUICtrlCreateMenu("&Control Panel")
	$ConPanel = GUICtrlCreateMenuItem("&Control Panel", $ControlMenu)
	GUICtrlCreateMenuItem("", $ControlMenu)
	$ConActCenter = GUICtrlCreateMenu("&Action Center", $ControlMenu)
	$CAActCenter = GUICtrlCreateMenuItem("&Action Center", $ConActCenter)
	GUICtrlCreateMenuItem("", $ConActCenter)
	$ConBackRest = GUICtrlCreateMenuItem("&Backup and Restore", $ControlMenu)

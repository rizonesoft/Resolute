...
#AutoIt3Wrapper_Res_Description=Datum Memory Booster
#AutoIt3Wrapper_Res_Fileversion=1.8.1.1817
#AutoIt3Wrapper_Res_Fileversion_AutoIncrement=y
#AutoIt3Wrapper_Res_LegalCopyright=© 2012, Datum
...
#AutoIt3Wrapper_Res_File_Add=resources\nn.bmp, rt_rcdata, NONO_IMAGE
...
Func _StartMainGUI()
	...
	GUICtrlSetOnEvent($miHome, "_DatumHome")
	...
	$btnOptimize = GUICtrlCreateButton("Optimize", 100, 70, 125, 35, $BS_DEFPUSHBUTTON)
	GUICtrlSetTip($btnOptimize,	"Optimize Memory now!", "Optimize Memory", 1, 1)
	GuiCtrlSetState($btnOptimize, $GUI_FOCUS)
	$btnOptions = GUICtrlCreateButton("Options...", 260, 70, 125, 35)
...
Func _AboutDlg()
	...
	Local $abHome, $abSupport, $picNoNo, $picDonate
	...
	GUICtrlCreateLabel("Copyright © 2012, Datum", 88, 55, 300, 20)
	GuiCtrlSetFont(-1, 9) ;Underlined
	GuiCtrlSetColor(-1, 0x555555)

	GUICtrlCreateLabel("Datum Home: ", 10, 90, 130, 15, $SS_RIGHT)
	$abHome = GUICtrlCreateLabel("https://www.datum-forensics.com", 145, 90, 250, 15)
	...
	$abSupport = GUICtrlCreateLabel("https://www.datum-forensics.com/contact", 145, 108, 250, 15)
	...
	$picNoNo = GUICtrlCreatePic("", 145, 130, 80, 15)
	_ResourceSetImageToCtrl($picNoNo, "NONO_IMAGE", $RT_RCDATA)
	GUICtrlSetCursor($picNoNo, 0)

	;Local $abLicense = GUICtrlCreateLabel("No Nonsense version 1.3", 175, 130, 159, 15)
	;GuiCtrlSetFont($abLicense, 9, -1, 4) ;Underlined
	;GuiCtrlSetColor($abLicense, 0x0000FF)
	;GuiCtrlSetCursor($abLicense, 0)

	$picDonate = GUICtrlCreatePic("", 160, 250, 62, 31)

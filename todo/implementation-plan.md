...
> **Progress:** **46 of 228 sections complete (20%).** Derived from the Implementation Order tables by `python scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T04 §36` | Campaign guard lifecycle follow-ups               |  11   |

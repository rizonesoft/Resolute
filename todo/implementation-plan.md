...
> **Progress:** **5 of 120 sections complete (4%).** Derived from the Implementation Order tables by `python scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T04 §2` | The Review-Finding Ledger                      |   8   |

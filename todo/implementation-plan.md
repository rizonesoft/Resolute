...
> **Progress:** **42 of 223 sections complete (19%).** Derived from the Implementation Order tables by `python scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T04 §31` | Red CI repaired, not waited on                    |   5   |

...
> **Progress:** **25 of 205 sections complete (12%).** Derived from the Implementation Order tables by `python scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T04 §15` | Run-record vocabulary and evidence follow-ups  |   9   |

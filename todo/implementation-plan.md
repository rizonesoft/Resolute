...
> **Progress:** **37 of 216 sections complete (17%).** Derived from the Implementation Order tables by `python scripts/todo-graph.py plan --sync` -- never edited by hand.
>
...
| [ ] | `D00 T04 §25` | Checker diagnostic follow-ups                  |  10   |

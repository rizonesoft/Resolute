...
- [ ] Record the four things that are **genuinely binding**, because they are the only ones. Done when: the list names the Kickass Undelete and SD Imager ports as permanently GPL v3 and never relicensable, Lucide as ISC requiring attribution, and the four AutoIt community UDFs below as unclear.
